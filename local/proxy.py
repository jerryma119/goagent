...
class Http(object):
    ...
    def __init__(self, min_window=4, max_window=64, max_retry=2, max_timeout=30, proxy_uri=''):
        ...
        self.window = 20
        self.window_ack = 0
        self.window_ipr = collections.defaultdict(lambda:5)
        ...
        for i in xrange(self.max_retry):
            ...
            for i in xrange(len(ips)):
                ...
                if sock:
                    ...
                    self.window_ipr[sock.getpeername()[0]] = time.time() - start_time
                    return sock
            else:
        ...
        for i in xrange(self.max_retry):
            ...
            for i in xrange(len(ips)):
                ...
                if ssl_sock:
                    ...
                    self.window_ipr[ssl_sock.getpeername()[0]] = time.time() - start_time
                    return ssl_sock
            else:
