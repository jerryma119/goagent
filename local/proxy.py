...
class Autoproxy2Pac(object):
    ...
    RULE_TAG_BEGIN = '// AUTO-GENERATED RULES, DO NOT MODIFY!'
    RULE_TAG_END   = '// END OF AUTO-GENERATED RULES'
...
function FindProxyForURL(url, host) {
    ...
    def generate_pac(self, filename):
        ...
        begin, end = content.find(self.RULE_TAG_BEGIN), content.find(self.RULE_TAG_END)
        content = content[:begin] + self.RULE_TAG_BEGIN + '\n' + jsrule + '\n' + content[end:]
    ...
    def update_filename(cls, filename, url, proxy, check_mtime=False):
        if check_mtime and os.path.exists(filename) and time.time() - os.path.getmtime(filename) < 10:
            return
